...
namespace SWSUploader
{
    public class DBManager
    {
        ...
        //파리미터값이 있는 트랜잭션 처리
        public string ExcuteTransactionParam(ParamQuery[] querys)
        {
            return MDB.ExcuteTransactionParameter(querys);
        }

        //파리미터값이 있는 트랜잭션 처리
        public string ExcuteTransactionParam(List<ParamQuery> querys)
        {
            return MDB.ExcuteTransactionParameter(querys.ToArray());
        }
