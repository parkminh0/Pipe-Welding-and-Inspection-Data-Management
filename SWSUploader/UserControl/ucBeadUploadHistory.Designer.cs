...
{
    partial class ucBeadUploadHistory
    {
        /// <summary> 
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ucBeadUploadHistory));
			...
			this.chkIsAllCompany = new DevExpress.XtraEditors.CheckEdit();
			this.chkIsAllProject = new DevExpress.XtraEditors.CheckEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.chkIsAllCompany.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.chkIsAllProject.Properties)).BeginInit();
			...
			this.panelControl1.Controls.Add(this.chkIsAllCompany);
			this.panelControl1.Controls.Add(this.chkIsAllProject);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(((DevExpress.XtraEditors.Controls.ButtonPredefines)(resources.GetObject("dteTo.Properties.CalendarTimeProperties.Buttons"))))});
			// 
			// dteFrom
			// 
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(((DevExpress.XtraEditors.Controls.ButtonPredefines)(resources.GetObject("dteFrom.Properties.CalendarTimeProperties.Buttons"))))});
			// 
			// txtUserID
			// 
			...
			// chkIsAllCompany
			// 
			resources.ApplyResources(this.chkIsAllCompany, "chkIsAllCompany");
			this.chkIsAllCompany.Name = "chkIsAllCompany";
			this.chkIsAllCompany.Properties.Caption = resources.GetString("chkIsAllCompany.Properties.Caption");
			this.chkIsAllCompany.Properties.DisplayValueChecked = resources.GetString("chkIsAllCompany.Properties.DisplayValueChecked");
			this.chkIsAllCompany.Properties.DisplayValueGrayed = resources.GetString("chkIsAllCompany.Properties.DisplayValueGrayed");
			this.chkIsAllCompany.Properties.DisplayValueUnchecked = resources.GetString("chkIsAllCompany.Properties.DisplayValueUnchecked");
			this.chkIsAllCompany.Properties.GlyphVerticalAlignment = ((DevExpress.Utils.VertAlignment)(resources.GetObject("chkIsAllCompany.Properties.GlyphVerticalAlignment")));
			this.chkIsAllCompany.CheckedChanged += new System.EventHandler(this.chkIsAllCompany_CheckedChanged);
			// 
			// chkIsAllProject
			// 
			resources.ApplyResources(this.chkIsAllProject, "chkIsAllProject");
			this.chkIsAllProject.Name = "chkIsAllProject";
			this.chkIsAllProject.Properties.Caption = resources.GetString("chkIsAllProject.Properties.Caption");
			this.chkIsAllProject.Properties.DisplayValueChecked = resources.GetString("chkIsAllProject.Properties.DisplayValueChecked");
			this.chkIsAllProject.Properties.DisplayValueGrayed = resources.GetString("chkIsAllProject.Properties.DisplayValueGrayed");
			this.chkIsAllProject.Properties.DisplayValueUnchecked = resources.GetString("chkIsAllProject.Properties.DisplayValueUnchecked");
			this.chkIsAllProject.Properties.GlyphVerticalAlignment = ((DevExpress.Utils.VertAlignment)(resources.GetObject("chkIsAllProject.Properties.GlyphVerticalAlignment")));
			this.chkIsAllProject.CheckedChanged += new System.EventHandler(this.chkIsAllProject_CheckedChanged);
			// 
			// txtSerialNo
			// 
			resources.ApplyResources(this.txtSerialNo, "txtSerialNo");
			this.txtSerialNo.Name = "txtSerialNo";
			this.txtSerialNo.Properties.Appearance.Options.UseTextOptions = true;
			this.txtSerialNo.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			// 
			// labelControl3
			// 
			...
			// rdoType
			// 
			resources.ApplyResources(this.rdoType, "rdoType");
			this.rdoType.Name = "rdoType";
			this.rdoType.Properties.Items.AddRange(new DevExpress.XtraEditors.Controls.RadioGroupItem[] {
            new DevExpress.XtraEditors.Controls.RadioGroupItem(((object)(resources.GetObject("rdoType.Properties.Items"))), resources.GetString("rdoType.Properties.Items1")),
            new DevExpress.XtraEditors.Controls.RadioGroupItem(((object)(resources.GetObject("rdoType.Properties.Items2"))), resources.GetString("rdoType.Properties.Items3"), ((bool)(resources.GetObject("rdoType.Properties.Items4"))), ((object)(resources.GetObject("rdoType.Properties.Items5"))), resources.GetString("rdoType.Properties.Items6"))});
			// 
			// groupControl2
			// 
			resources.ApplyResources(this.groupControl2, "groupControl2");
			this.groupControl2.Controls.Add(this.grdHistory);
			this.groupControl2.Name = "groupControl2";
			// 
			// grdHistory
			// 
			resources.ApplyResources(this.grdHistory, "grdHistory");
			this.grdHistory.EmbeddedNavigator.AccessibleDescription = resources.GetString("grdHistory.EmbeddedNavigator.AccessibleDescription");
			this.grdHistory.EmbeddedNavigator.AccessibleName = resources.GetString("grdHistory.EmbeddedNavigator.AccessibleName");
			this.grdHistory.EmbeddedNavigator.AllowHtmlTextInToolTip = ((DevExpress.Utils.DefaultBoolean)(resources.GetObject("grdHistory.EmbeddedNavigator.AllowHtmlTextInToolTip")));
			this.grdHistory.EmbeddedNavigator.Anchor = ((System.Windows.Forms.AnchorStyles)(resources.GetObject("grdHistory.EmbeddedNavigator.Anchor")));
			this.grdHistory.EmbeddedNavigator.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("grdHistory.EmbeddedNavigator.BackgroundImage")));
			this.grdHistory.EmbeddedNavigator.BackgroundImageLayout = ((System.Windows.Forms.ImageLayout)(resources.GetObject("grdHistory.EmbeddedNavigator.BackgroundImageLayout")));
			this.grdHistory.EmbeddedNavigator.ImeMode = ((System.Windows.Forms.ImeMode)(resources.GetObject("grdHistory.EmbeddedNavigator.ImeMode")));
			this.grdHistory.EmbeddedNavigator.MaximumSize = ((System.Drawing.Size)(resources.GetObject("grdHistory.EmbeddedNavigator.MaximumSize")));
			this.grdHistory.EmbeddedNavigator.TextLocation = ((DevExpress.XtraEditors.NavigatorButtonsTextLocation)(resources.GetObject("grdHistory.EmbeddedNavigator.TextLocation")));
			this.grdHistory.EmbeddedNavigator.ToolTip = resources.GetString("grdHistory.EmbeddedNavigator.ToolTip");
			this.grdHistory.EmbeddedNavigator.ToolTipIconType = ((DevExpress.Utils.ToolTipIconType)(resources.GetObject("grdHistory.EmbeddedNavigator.ToolTipIconType")));
			this.grdHistory.EmbeddedNavigator.ToolTipTitle = resources.GetString("grdHistory.EmbeddedNavigator.ToolTipTitle");
			this.grdHistory.MainView = this.gridView1;
			...
			this.gridColumn1.FieldName = "BeadKey";
			...
			this.gridColumn2.FieldName = "ProjectKey";
			...
			this.gridColumn12.FieldName = "InspectionNo";
			...
			this.gridColumn6.FieldName = "InspectionDate";
			...
			this.gridColumn7.FieldName = "Material";
			...
			this.gridColumn9.FieldName = "WallThickness";
			...
			this.gridColumn10.FieldName = "SDR";
			...
			this.gridColumn11.FieldName = "CreateID";
			...
			this.gridColumn13.FieldName = "CreateDtm";
			...
			this.Name = "ucBeadUploadHistory";
			this.Load += new System.EventHandler(this.ucUploadHistory_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.chkIsAllCompany.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.chkIsAllProject.Properties)).EndInit();
        ...
        private DevExpress.XtraEditors.CheckEdit chkIsAllCompany;
        private DevExpress.XtraEditors.CheckEdit chkIsAllProject;
