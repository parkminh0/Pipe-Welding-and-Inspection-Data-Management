namespace SWSAnalyzer
{
    partial class FormPopProject
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormPopProject));
			...
			this.txtProjectKey = new DevExpress.XtraEditors.TextEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtProjectKey.Properties)).BeginInit();
			...
			this.layoutControl1.Controls.Add(this.txtProjectKey);
			...
			// txtProjectKey
			// 
			resources.ApplyResources(this.txtProjectKey, "txtProjectKey");
			this.txtProjectKey.Name = "txtProjectKey";
			this.txtProjectKey.Properties.Appearance.Options.UseTextOptions = true;
			this.txtProjectKey.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.txtProjectKey.Properties.ReadOnly = true;
			this.txtProjectKey.StyleController = this.layoutControl1;
			// 
			// layoutControlGroup1
			// 
			...
			this.layoutControlItem1.Control = this.txtProjectKey;
			...
			this.layoutControlItem6.Size = new System.Drawing.Size(388, 43);
			...
			this.IconOptions.Icon = ((System.Drawing.Icon)(resources.GetObject("FormPopProject.IconOptions.Icon")));
			this.MaximizeBox = false;
			this.MinimizeBox = false;
			this.Name = "FormPopProject";
			this.Load += new System.EventHandler(this.FormPopProject2_Load);
			this.Shown += new System.EventHandler(this.FormPopProject2_Shown);
			...
			((System.ComponentModel.ISupportInitialize)(this.txtProjectKey.Properties)).EndInit();
        ...
        private DevExpress.XtraEditors.TextEdit txtProjectKey;
